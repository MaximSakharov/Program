...
/*
@brief Найти самое маленькое число, которое делится нацело на все числа от 1 до введённого делителя
@param divider_: делитель числа
@return Самое маленькое число, которое делится нацело на все числа от 1 до введённого делителя
*/
