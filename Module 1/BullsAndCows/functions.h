...
/*
@brief Определяет является ли число четырёхзначным.
@param value_ : Число.
@return true - четырёхзначное, false - не четырёхзначное.
*/
...
@param value_ : Число.
@return true - числа совпадают, false - числа не совпадают.
*/
